...
<div class="content-wrapper">
	...
	<section class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1>Riwayat Surat Tanda Lulus Sementara</h1>
				</div>
					...
					<div class="card">
						<div class="card-body">
							<table class="table table-striped">
								<tbody>
								<?php foreach($pilihan9->result_array() as $rowSurat):;?>
									<tr>
										<th scope="row" width="20%">Tempat Lahir</th>
										<td width="5%">:</td>
										<td ><?= ucwords(sanitasi($rowSurat['tempat_lahir']));?></td>
									</tr>
									<tr>
										<th scope="row" width="20%">Tanggal Lahir</th>
										<td width="5%">:</td>
										<td><?= date("d-m-Y",strtotime(sanitasi($rowSurat['tanggal_lahir'])));?></td>
