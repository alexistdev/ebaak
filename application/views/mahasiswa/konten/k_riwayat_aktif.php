...
<div class="content-wrapper">
	...
	<section class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1>Riwayat Surat Permohonan Aktif Kembali</h1>
				</div>
					...
					<div class="card">
						<div class="card-body">
							<table class="table table-striped">
								<tbody>
								<?php foreach($pilihan4->result_array() as $rowSurat):;?>
									<tr>
										<th scope="row" width="20%">Jenis Surat</th>
										<td width="5%">:</td>
										<td >Surat Permohonan Aktif Akademik</td>
									</tr>
									<tr>
										<th scope="row" width="20%">Alasan Aktif</th>
										<td width="5%">:</td>
										<td ><?= ucfirst(sanitasi($rowSurat['alasan_aktif']));?></td>
									</tr>
