...
<div class="content-wrapper">
	...
	<section class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1>Riwayat Surat Pindah Program Studi</h1>
				</div>
					...
					<div class="card">
						<div class="card-body">
							<table class="table table-striped">
								<tbody>
								<?php foreach($pilihan8->result_array() as $rowSurat):;?>
									<tr>
										<th scope="row" width="20%">Nama Program Studi</th>
										<td width="5%">:</td>
										<td ><?= ucwords(sanitasi($rowSurat['nama_prodi']));?></td>
									</tr>
									<tr>
