...
<div class="content-wrapper">
	...
	<section class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1>Riwayat Surat Kerja Praktek</h1>
				</div>
					...
					<div class="card">
						<div class="card-body">
							<table class="table table-striped">
								<tbody>
								<?php foreach($pilihan6->result_array() as $rowSurat):;?>
									<tr>
									...
									<tr>
										<th scope="row" width="20%">Alamat</th>
										<td width="5%">:</td>
										<td><?= ucfirst(sanitasi($rowSurat['keterangan']));?></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td width="5%">:</td>
										<td><?= date("d-m-Y",strtotime(sanitasi($rowSurat['tanggal_berakhir'])));?></td>
									</tr>
									<tr>
